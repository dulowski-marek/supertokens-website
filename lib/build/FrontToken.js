...
var FrontToken = /** @class */ (function () {
    ...
    FrontToken.getTokenInfo = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch_1.getFrontToken()];
                    case 1:
                        frontToken = _a.sent();
                        if (frontToken === null) {
    ...
    FrontToken.removeToken = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch_1.setFrontToken(undefined)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    FrontToken.setItem = function (frontToken) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, fetch_1.setFrontToken(frontToken)];
                    case 1:
                        _e.sent();
                        _b = (_a = this.frontToken$).next;
                        _d = (_c = Optional_1.Optional).of;
    ...
    FrontToken.subscribe = function (observer) {
        return this.frontToken$.subscribe(observer);
    };
    FrontToken.frontToken$ = new Subject_1.Subject();
    return FrontToken;
}());
exports.FrontToken = FrontToken;
//# sourceMappingURL=FrontToken.js.map