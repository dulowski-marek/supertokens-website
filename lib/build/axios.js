        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    try {
                        doNotDoInterception =
                            typeof url === "string" && utils_1.normaliseURLDomainOrThrowError(url) !== fetch_1.default.apiDomain;
                    }
                    catch (err) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 7:
                    ...
                    return [4 /*yield*/, FrontToken_1.FrontToken.setItem(frontToken)];
                case 8:
                    _b.sent();
                    _b.label = 9;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 12:
                        ...
                        return [4 /*yield*/, fetch_1.handleUnauthorised(fetch_1.default.refreshTokenUrl, preRequestIdToken, fetch_1.default.refreshAPICustomHeaders, fetch_1.default.sessionExpiredStatusCode)];
                    case 13:
                        retry = _b.sent();
                        if (!retry) {
                            returnObj = response;
                    ...
                    case 21:
                        ...
                        if (!(err_1.response !== undefined &&
                            err_1.response.status === fetch_1.default.sessionExpiredStatusCode)) return [3 /*break*/, 23];
                        return [4 /*yield*/, fetch_1.handleUnauthorised(fetch_1.default.refreshTokenUrl, preRequestIdToken, fetch_1.default.refreshAPICustomHeaders, fetch_1.default.sessionExpiredStatusCode)];
                    case 22:
                        retry = _b.sent();
                        if (!retry) {
                    ...
                    case 26:
                        ...
                        return [3 /*break*/, 32];
                    case 27: return [4 /*yield*/, fetch_1.default.doesSessionExist()];
                    case 28:
