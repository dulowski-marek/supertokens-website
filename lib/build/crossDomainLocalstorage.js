...
var CrossDomainLocalstorage = /** @class */ (function () {
    function CrossDomainLocalstorage(sessionScope) {
        ...
        this.sendMessageAndGetResponseToDestinationIframe = function (message) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        dataPromise = new Promise(function (res) {
                            var waiterFunction = function (data) {
                                if (data.id === currId) {
                                    ...
                                    _this.waiterFunctionsForResultFromIframe = _this.waiterFunctionsForResultFromIframe.filter(function (func) { return func !== waiterFunction; });
                                }
                            };
        ...
        this.iFrameListener = function (event) {
            ...
            if (!new URL(event.origin).hostname.endsWith(_this.sessionScope.scope) &&
        ...
        this.getItem = function (key) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3: return [4 /*yield*/, this.sendMessageAndGetResponseToDestinationIframe({
                            action: "getItem",
                            key: key
                        })];
        ...
        this.removeItem = function (key) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1: return [4 /*yield*/, this.sendMessageAndGetResponseToDestinationIframe({
                            action: "removeItem",
                            key: key
                        })];
                    case 2:
        ...
        if (sessionScope !== undefined) {
            ...
            iframe_1.addEventListener("load", function () {
                ...
                for (var i = 0; i < _this.toSendMessageQueueBeforeIframeLoads.length; i++) {
                    _this.iframe.contentWindow.postMessage(_this.toSendMessageQueueBeforeIframeLoads[i], sessionScope.authDomain);
                }
