...
var FrontToken_1 = require("./FrontToken");
var GlobalSessionManager_1 = require("./GlobalSessionManager");
...
function handleUnauthorised(refreshAPI, preRequestIdToken, refreshAPICustomHeaders, sessionExpiredStatusCode) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, onUnauthorisedResponse(refreshAPI, preRequestIdToken, refreshAPICustomHeaders, sessionExpiredStatusCode)];
                case 1:
                    result = _a.sent();
...
var AuthHttpRequest = /** @class */ (function () {
    ...
    AuthHttpRequest.init = function (options) {
        var _a = utils_1.validateAndNormaliseInputOrThrowError(options), apiDomain = _a.apiDomain, apiBasePath = _a.apiBasePath, sessionScope = _a.sessionScope, refreshAPICustomHeaders = _a.refreshAPICustomHeaders, signoutAPICustomHeaders = _a.signoutAPICustomHeaders, sessionExpiredStatusCode = _a.sessionExpiredStatusCode, autoAddCredentials = _a.autoAddCredentials, isInIframe = _a.isInIframe;
        ...
        FrontToken_1.FrontToken.subscribe(GlobalSessionManager_1.default);
    ...
    AuthHttpRequest.getUserId = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, FrontToken_1.FrontToken.getTokenInfo()];
                    case 1:
                        tokenInfo = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, handleUnauthorised(AuthHttpRequest.refreshTokenUrl, preRequestIdToken, AuthHttpRequest.refreshAPICustomHeaders, AuthHttpRequest.sessionExpiredStatusCode)];
                    case 3:
                        retry = _a.sent();
                        if (!retry) return [3 /*break*/, 5];
                        return [4 /*yield*/, AuthHttpRequest.getJWTPayloadSecurely()];
                    case 4: return [2 /*return*/, _a.sent()];
                    case 5: throw new Error("Could not refresh session");
                    case 6: return [2 /*return*/, tokenInfo.up];
                }
            });
        });
    };
    AuthHttpRequest.signOut = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, AuthHttpRequest.doesSessionExist()];
                    case 1:
                        if (!(_a.sent())) {
                            return [2 /*return*/];
                        }
                        return [4 /*yield*/, fetch(AuthHttpRequest.signOutUrl, {
                                method: "post",
                                credentials: "include",
                                headers: AuthHttpRequest.signoutAPICustomHeaders === undefined
                                    ? undefined
    ...
    AuthHttpRequest.doRequest = function (httpCall, config, url) { return __awaiter(_this, void 0, void 0, function () {
        var doNotDoInterception, throwError, returnObj, preRequestIdToken, configWithAntiCsrf, antiCsrfToken, response, retry, err_1, retry;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    try {
                        ...
                        if (err.message === "Please provide a valid domain name") {
                            ...
                            doNotDoInterception =
                                utils_1.normaliseURLDomainOrThrowError(window.location.origin) !== AuthHttpRequest.apiDomain &&
                                    AuthHttpRequest.addedFetchInterceptor;
                        }
                        else {
                            throw err;
                ...
                case 9:
                    response = _a.sent();
                    return [4 /*yield*/, loopThroughResponseHeadersAndApplyFunction(response, function (value, key) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                ...
                case 11:
                    ...
                    return [3 /*break*/, 14];
                case 12: return [4 /*yield*/, loopThroughResponseHeadersAndApplyFunction(response, function (value, key) { return __awaiter(_this, void 0, void 0, function () {
                        var tok;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                ...
                                case 4:
                                    ...
                                    return [4 /*yield*/, FrontToken_1.FrontToken.setItem(value)];
                                case 5:
                                    _a.sent();
                                    _a.label = 6;
                ...
                case 20:
                    ...
                    return [3 /*break*/, 26];
                case 21: return [4 /*yield*/, index_1.doesSessionExist()];
                case 22:
                    if (!!(_a.sent())) return [3 /*break*/, 25];
                    return [4 /*yield*/, AntiCsrfToken.removeToken()];
                case 23:
                    _a.sent();
                    return [4 /*yield*/, FrontToken_1.FrontToken.removeToken()];
                case 24:
                    _a.sent();
                    _a.label = 25;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, handleUnauthorised(AuthHttpRequest.refreshTokenUrl, preRequestIdToken, AuthHttpRequest.refreshAPICustomHeaders, AuthHttpRequest.sessionExpiredStatusCode)];
                case 3: return [2 /*return*/, _a.sent()];
                case 4: return [4 /*yield*/, index_1.doesSessionExist()];
                case 5:
    ...
    AuthHttpRequest.doesSessionExist = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _loop_1 = function () {
                        var postLockID, headers, antiCsrfToken, response, removeIdRefreshToken_1, error_1, idCookieValue;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 5:
                                    ...
                                    return [4 /*yield*/, AuthHttpRequest.env.__supertokensOriginalFetch(refreshTokenUrl, {
                                            method: "post",
                                            credentials: "include",
                                            headers: headers
                                        })];
                                ...
                                case 14:
                                    ...
                                    return [7 /*endfinally*/];
                                case 15: return [4 /*yield*/, getIdRefreshToken(false)];
                                case 16:
    ...
    return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.sent();
                            _a.label = 3;
                        case 3: return [2 /*return*/, fromLocalstorage === null ? undefined : fromLocalstorage];
                    }
                });
            });
        }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, handleUnauthorised(AuthHttpRequest.refreshTokenUrl, response, AuthHttpRequest.refreshAPICustomHeaders, AuthHttpRequest.sessionExpiredStatusCode)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
    ...
    return __awaiter(this, void 0, void 0, function () {
        function setIDToCookie(idRefreshToken, domain) {
            ...
            if (domain === "localhost" || domain === window.location.hostname) {
                ...
                utils_1.getWindowOrThrow().document.cookie = ID_REFRESH_TOKEN_NAME + "=" + cookieVal + ";expires=" + expires + ";path=/;samesite=" + (AuthHttpRequest.isInIframe ? "none;secure" : "lax");
            }
            else {
                utils_1.getWindowOrThrow().document.cookie = ID_REFRESH_TOKEN_NAME + "=" + cookieVal + ";expires=" + expires + ";domain=" + domain + ";path=/;samesite=" + (AuthHttpRequest.isInIframe ? "none;secure" : "lax");
            }
        }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setIDToCookie(idRefreshToken, AuthHttpRequest.sessionScope === undefined
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4: return [2 /*return*/, fromLocalstorage];
            }
        });
    });
}
        ...
        function setAntiCSRFToCookie(antiCSRFToken, domain) {
            ...
            if (domain === "localhost" || domain === window.location.hostname) {
                ...
                if (expires !== undefined) {
                    utils_1.getWindowOrThrow().document.cookie = ANTI_CSRF_NAME + "=" + cookieVal + ";expires=" + expires + ";path=/;samesite=" + (AuthHttpRequest.isInIframe ? "none;secure" : "lax");
                }
                else {
                    utils_1.getWindowOrThrow().document.cookie = ANTI_CSRF_NAME + "=" + cookieVal + ";expires=Fri, 31 Dec 9999 23:59:59 GMT;path=/;samesite=" + (AuthHttpRequest.isInIframe ? "none;secure" : "lax");
                }
            }
            else {
                if (expires !== undefined) {
                    utils_1.getWindowOrThrow().document.cookie = ANTI_CSRF_NAME + "=" + cookieVal + ";expires=" + expires + ";domain=" + domain + ";path=/;samesite=" + (AuthHttpRequest.isInIframe ? "none;secure" : "lax");
                }
                else {
                    utils_1.getWindowOrThrow().document.cookie = ANTI_CSRF_NAME + "=" + cookieVal + ";domain=" + domain + ";expires=Fri, 31 Dec 9999 23:59:59 GMT;path=/;samesite=" + (AuthHttpRequest.isInIframe ? "none;secure" : "lax");
                }
            }
        }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setAntiCSRFToCookie(antiCSRFToken, AuthHttpRequest.sessionScope === undefined
                        ? utils_1.normaliseSessionScopeOrThrowError(utils_1.getWindowOrThrow().location.hostname)
                        : AuthHttpRequest.sessionScope.scope);
    ...
    return __awaiter(this, void 0, void 0, function () {
        function setFrontTokenToCookie(frontToken, domain) {
            ...
            if (domain === "localhost" || domain === window.location.hostname) {
                ...
                // see https://github.com/supertokens/supertokens-website/issues/25
                if (expires !== undefined) {
                    utils_1.getWindowOrThrow().document.cookie = FRONT_TOKEN_NAME + "=" + cookieVal + ";expires=" + expires + ";path=/;samesite=" + (AuthHttpRequest.isInIframe ? "none;secure" : "lax");
                }
                else {
                    utils_1.getWindowOrThrow().document.cookie = FRONT_TOKEN_NAME + "=" + cookieVal + ";expires=Fri, 31 Dec 9999 23:59:59 GMT;path=/;samesite=" + (AuthHttpRequest.isInIframe ? "none;secure" : "lax");
                }
            }
            else {
                if (expires !== undefined) {
                    utils_1.getWindowOrThrow().document.cookie = FRONT_TOKEN_NAME + "=" + cookieVal + ";expires=" + expires + ";domain=" + domain + ";path=/;samesite=" + (AuthHttpRequest.isInIframe ? "none;secure" : "lax");
                }
                else {
                    utils_1.getWindowOrThrow().document.cookie = FRONT_TOKEN_NAME + "=" + cookieVal + ";domain=" + domain + ";expires=Fri, 31 Dec 9999 23:59:59 GMT;path=/;samesite=" + (AuthHttpRequest.isInIframe ? "none;secure" : "lax");
                }
            }
        }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setFrontTokenToCookie(frontToken, AuthHttpRequest.sessionScope === undefined
                        ? utils_1.normaliseSessionScopeOrThrowError(utils_1.getWindowOrThrow().location.hostname)
                        : AuthHttpRequest.sessionScope.scope);
